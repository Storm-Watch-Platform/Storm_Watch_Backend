...
import (
	...
	domain "github.com/Storm-Watch-Platform/Storm_Watch_Backend/domain"
...
func (_m *SignupUsecase) GetUserByPhone(c context.Context, email string) (domain.User, error) {
